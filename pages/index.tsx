  ...
  <Layout title="Coming Soon - what.gift">
    ...
    <div className="absolute bottom-5">
      <ul className="flex space-x-3">
        <li>
          <a href="https://www.instagram.com/what_gift/" className="flex items-center justify-center w-10 h-10 rounded-full bg-gray-50 transition ease-in-out duration-500 hover:bg-red-500 hover:text-white hover:shadow-lg" target="_blank">
              <svg
                className="w-6 h-6"
                fill="currentColor"
                viewBox="0 0 24 24"
